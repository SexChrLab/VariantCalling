...
configfile: "xy_var_calling_pilot_01.config.json"
...
rule all:
    input:
        ...
        #expand(os.path.join(config["proj_path"], "vcfs/males/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_{chrms}.recalibrated_variants_{sample}_biallelic_SNPs.vcf"), chrms=config["chromosomes_m"], sample=config["males"]),
        ...
        #expand(os.path.join(config["proj_path"], "vcfs/males/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_chrM.recalibrated_variants_{sample}_biallelic_SNPs.vcf"), sample=config["males"]),
        ...
        #expand(os.path.join(config["proj_path"], "vcfs/males/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_{chrms}.recalibrated_variants_{sample}_biallelic_SNPs_PARs.vcf"), chrms=config["chrX"], sample=config["males"]),
        #expand(os.path.join(config["proj_path"], "vcfs/males/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_{chrms}.recalibrated_variants_{sample}_biallelic_SNPs_nonPARs.vcf"), chrms=config["chrX"], sample=config["males"]),
        ...
        #expand(os.path.join(config["proj_path"], "vcfs/females/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_{chrms}.recalibrated_variants_{sample}_biallelic_SNPs.vcf"), chrms=config["chromosomes_f"], sample=config["females"]),
        ...
        #expand(os.path.join(config["proj_path"], "vcfs/females/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_chrM.recalibrated_variants_{sample}_biallelic_SNPs.vcf"), sample=config["females"]),
        ...
        #expand(os.path.join(config["proj_path"], "vcfs/females/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_{chrms}.recalibrated_variants_{sample}_biallelic_SNPs_PARs.vcf"), chrms=config["chrX"], sample=config["females"]),
        #expand(os.path.join(config["proj_path"], "vcfs/females/{sample}/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_{chrms}.recalibrated_variants_{sample}_biallelic_SNPs_nonPARs.vcf"), chrms=config["chrX"], sample=config["females"]),
...
# Note to self: Eventually will need to zip these files to save space (after simulation)
# FEMALES #
# Select biallelic snps only for the specific sample we are analyzing.
