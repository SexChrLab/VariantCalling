...
snakemake -s fastqsToBams.snakefile -j 30 --latency-wait 60 --cluster-config cluster.json --cluster "sbatch -n {cluster.n} --nodes 1 -t {cluster.t}:00:00 --mail-type=END,FAIL --mail-user=amtarave@asu.edu "
