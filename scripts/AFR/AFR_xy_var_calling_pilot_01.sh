#!/bin/bash
#SBATCH --job-name=AFR_01_xy_var_calling_pilot # Job name
...
snakemake -s AFR_xy_var_calling_pilot_01.snakefile --rerun-incomplete -j 1000 --cluster "sbatch -n 2 -t 4-00:00:00 -q tempboost --mail-type=END,FAIL --mail-user=amtarave@asu.edu"
